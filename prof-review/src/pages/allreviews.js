...
export default function AllReviews() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      <h1 className="text-4xl font-bold text-gray-900 text-center">All Reviews</h1>
      <p className="text-lg text-gray-600 text-center mb-6">Browse student reviews and filter by course, professor, or tags.</p>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg w-96">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {["Tag1", "Tag2", "Tag3"].map((tag) => (
                <button
                  ...
                  onClick={() => setUpdatedTags((prevTags) =>
            ...
            <div className="flex space-x-1 mt-4">
              {[1, 2, 3, 4, 5].map((star) => (
                <FaStar
                  key={star}
                  className={`text-xl cursor-pointer ${star <= updatedRating ? "text-yellow-500" : "text-gray-300"}`}
